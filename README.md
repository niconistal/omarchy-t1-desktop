# T1 Touch Bar Desktop

An [Omarchy](https://omarchy.org) plugin that wires the Touch Bar of a T1
MacBook Pro, driven by [T1Bridge](https://github.com/standardagents/t1bridge),
to the desktop it sits under.
